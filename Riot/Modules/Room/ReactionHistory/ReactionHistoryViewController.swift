...
final class ReactionHistoryViewController: UIViewController {
    ...
    private var theme: ThemeReaction!
    ...
    override func viewDidLoad() {
        ...
        self.title = "reaction_history_title".localized()
    ...
    private func update(theme: ThemeReaction) {
        self.theme = theme
...
//        self.update(theme: ThemeService.shared().theme) // tiemlv
    ...
    private func setupViews() {
        let closeBarButtonItem = MXKBarButtonItem(title: "close".localized(), style: .plain) { [weak self] in
