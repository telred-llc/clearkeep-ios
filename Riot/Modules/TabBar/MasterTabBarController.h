...
@class CkAuthenticationViewController;
...
@property (nonatomic, readonly) CkAuthenticationViewController *authViewController;
...
@property (nonatomic, readwrite) BOOL isCkAuthViewControllerPreparing;
