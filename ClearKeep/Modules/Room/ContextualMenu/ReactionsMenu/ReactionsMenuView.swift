...
final class ReactionsMenuView: UIView, NibLoadable {
...
//        let moreReactionsImage = #imageLiteral(resourceName: "more_reactions").withRenderingMode(.alwaysTemplate)
...
//        self.moreReactionsBackgroundView.layer.cornerRadius = self.moreReactionsBackgroundView.frame.size.height/2
    ...
    func updateTheme() {
        themeService.rx
            .bind({ $0.headerBackgroundColor }, to: self.reactionsBackgroundView.rx.backgroundColor)
    ...
    func selectionAnimationInstructionPart1() {
        ...
        tappedButton.superview?.bringSubview(toFront: tappedButton)
