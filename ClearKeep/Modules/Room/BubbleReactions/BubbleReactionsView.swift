...
final class BubbleReactionsView: UIView, NibOwnerLoadable {
    ...
    private func actionButtonString() -> String {
        ...
        case .showAll:
            actionString = CKLocalization.string(byKey: "room_event_action_reaction_show_all")
        case .showLess:
            actionString = CKLocalization.string(byKey: "room_event_action_reaction_show_less")
        case .none:
            actionString = ""
        }
