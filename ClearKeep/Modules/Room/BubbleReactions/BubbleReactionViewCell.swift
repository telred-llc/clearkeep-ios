...
final class BubbleReactionViewCell: UICollectionViewCell, NibReusable {
    ...
    func updateTheme() {
        themeService.rx
            .bind({ $0.tintColor.cgColor }, to: self.reactionBackgroundView.layer.rx.borderColor)
            .bind({ $0.textPrimaryColor }, to: self.emojiLabel.rx.textColor, self.countLabel.rx.textColor) 
