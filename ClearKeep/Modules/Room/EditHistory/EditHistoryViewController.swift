...
final class EditHistoryViewController: UIViewController {
    ...
    class func instantiate(with viewModel: EditHistoryViewModelType) -> EditHistoryViewController {
        let viewController = StoryboardScene.EditHistoryVC.initialScene.instantiate()
    ...
    override func viewDidLoad() {
        ...
        self.title = CKLocalization.string(byKey: "room_message_edits_history_title")
    ...
    private func updateTheme() {
        ...
        themeService.rx
            .bind({ $0.secondBgColor }, to: self.view.rx.backgroundColor, self.tableView.rx.backgroundColor)
            .disposed(by: disposeBag)
    }
...
extension EditHistoryViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        editHistoryHeaderView.updateTheme()
